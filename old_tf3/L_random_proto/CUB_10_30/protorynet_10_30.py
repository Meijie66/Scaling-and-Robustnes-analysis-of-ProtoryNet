...
class ProtoryNet:
    ...
    def createModel(self,k_cents,k_protos=30,vect_size=512,alpha=0.0001,beta=0.01):
    ...
    def showPrototypes(self,sample_sentences,sample_sent_vects,k_protos=30,printOutput=False):

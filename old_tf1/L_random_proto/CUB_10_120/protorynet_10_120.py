...
class ProtoryNet:
    ...
    def createModel(self,k_cents,k_protos=120,vect_size=512,alpha=0.0001,beta=0.01):
        ...
        class CustomModel(keras.Model):
            ...
            def train_step(self, data):
                ...
                with tf.GradientTape() as tape:
                    ...
                    #print('y_constant:', y_constant, y_constant.shape)
                    y_val = tf.one_hot(y_1,10)
        ...
        print("Total trainable parameters in the proto_layer:", self.proto_layer.count_params()) 
        ...
        z1 = tf.keras.layers.Dense(10, activation='softmax')(lstmop[:, -1, :])
    ...
    def evaluate(self,x_valid, y):
        ...
        for x, y in zip(x_valid, y):
            ...
            y_pred_labels = tf.argmax(y_pred)
            #print('y_pred_labels:',y_pred_labels)
            y_preds.append(y_pred)
            
            if count % 30 == 0:
                print('Evaluating y_pred, y ', y_pred, y_pred_labels, y)
            if y_pred_labels == y:
                right += 1
            else:
                wrong += 1
    ...
    #sample_sent_vects
    def projection(self,sample_sentences,sample_sent_vects,data_size=3000):
    ...
    def showPrototypes(self,sample_sentences,sample_sent_vects,k_protos=120,printOutput=False):

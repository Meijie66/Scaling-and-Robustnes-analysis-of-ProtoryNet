...
class ProtoryNet:
    ...
    def createModel(self,k_cents,k_protos=15,vect_size=512,alpha=0.0001,beta=0.01):
        ...
        z1 = tf.keras.layers.Dense(3, activation='softmax')(lstmop[:, -1, :])
    ...
    #sample_sent_vects
    def projection(self,sample_sentences,sample_sent_vects,data_size=600):
    ...
    def showPrototypes(self,sample_sentences,sample_sent_vects,k_protos=15,printOutput=False):

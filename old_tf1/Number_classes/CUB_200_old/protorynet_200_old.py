...
class ProtoryNet:
    ...
    def createModel(self,k_cents,k_protos=1000,vect_size=512,alpha=0.0001,beta=0.01):
        ...
        z1 = tf.keras.layers.Dense(200, activation='softmax')(lstmop[:, -1, :])
    ...
    def evaluate(self,x_valid, y):
        ...
        for x, y in zip(x_valid, y):
            ...
            if count % 300 == 0:
                print('Evaluating y_pred, y ', y_pred_labels, y)
            if y_pred_labels == y:
                right += 1
            else:
                wrong += 1
    ...
    #sample_sent_vects
    def projection(self,sample_sentences,sample_sent_vects,data_size=50000):
    ...
    def showPrototypes(self,sample_sentences,sample_sent_vects,k_protos=1000,printOutput=False):
